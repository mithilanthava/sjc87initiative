          ...
          >
            {
              imgLinks.map(l => (
                <SwiperSlide key={l}>
                  <img src={l} alt="Slider Image" className="w-full h-[300px] md:h-[400px] 2xl:h-[600px] object-cover"/>
                </SwiperSlide>
              ))
            }
          </Swiper>
        ...
        <div className="container">
          ...
          <div className="content mt-10 flex flex-col md:flex-row justify-center items-center w-full pb-10">
            <div className="img md:w-1/2">
              <img src="/img/index/index1.png" alt="Index 1" className="object-cover" />
            </div>
            <div className="text md:w-1/2">
              <h2 className="text-4xl text-center md:text-left md:text-4xl xl:text-6xl font-bold text-gray-600 mt-5 md:mt-0">Your <span className="text-orange-500">Support</span> Makes a Difference</h2>
              <p className="text-xl pt-5 pb-10 text-gray-500 text-center md:text-left md:w-2/3">Helping young people grow into healthy, educated and productive adults.</p>
              <Link href='/donation'>
                <a className="text-xl py-2 px-4 border border-orange-500 text-orange-500 font-semibold rounded md:w-2/5 flex justify-center items-center">Donations</a>
              </Link>
            </div>
          </div>
          ...
          <div className="content mt-10 flex flex-col md:flex-row-reverse justify-center items-center w-full pb-10">
            <div className="img md:w-1/2 flex justify-center items-center">
              <img src="/img/index/index2.JPG" alt="Index 2" className="object-cover h-[400px] w-4/5 rounded shadow-md" />
            </div>
            <div className="text md:w-1/2">
              <h2 className="text-4xl text-center md:text-left md:text-4xl xl:text-6xl font-bold text-gray-600 mt-5 md:mt-0">Our <span className="text-orange-500">Mission</span></h2>
              <p className="text-xl pt-5 pb-10 text-gray-500 text-center md:text-left md:w-4/5">Our mission is to improve and create educational excellence together with character development for school students in the North and East of Sri Lanka.</p>
            </div>
          </div>
          ...
          <div className="content mt-10 flex flex-col md:flex-row justify-center items-center w-full py-10">
            <div className="img md:w-1/2 flex justify-center items-center">
              <img src="/img/slider/slider2.jpg" alt="Index 3" className="object-cover h-[400px] w-4/5 rounded shadow-md" />
            </div>
            <div className="text md:w-1/2">
              <h2 className="text-4xl text-center md:text-left md:text-4xl xl:text-6xl font-bold text-gray-600 mt-5 md:mt-0">Our <span className="text-orange-500">Focus</span></h2>
              <p className="text-xl pt-5 pb-10 text-gray-500 text-center md:text-left md:w-4/5">We help children  break the cycle of poverty by empowering  them to dream, aspire and achieve through Education.</p>
            </div>
          </div>
        </div>
