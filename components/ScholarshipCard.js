    ...
    <>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-5">
        ...
        <div className="card p-5 bg-white shadow-md rounded border">
          ...
          <p className="text-justify text-gray-500">The sponsorship is offered to the students from the  rural areas who are going to Universities located in the Urban areas. These scholarships generally cover living expenses away from home for these students. Annual Sponsorship amounts are AUD$550/CAD$500/GBP 300/ USD 400. These sponsorships will be for the period of the Course chosen, majority of them are for 4 years.</p>
        </div>
      </div>
    </>
  )
